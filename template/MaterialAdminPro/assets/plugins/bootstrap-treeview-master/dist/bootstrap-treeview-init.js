$(function() {
		...
		$.ajax({ 
			...
			success: function(data)  
			{
				$('#treeview4').treeview({
					color: "#428bca",
					selectedBackColor: "#03a9f3 !important",
					onhoverColor: "rgba(0, 0, 0, 0.05) !important",
					expandIcon: 'ti-plus',
					collapseIcon: 'ti-minus',
					nodeIcon: 'fa fa-folder',
					...
					onNodeSelected: function(event, node) {
						...
						var id=node.id;
						jQuery('#peraturan_treeview').html('<div class="container">'+
															  ...
															  '</div>'+
															'</div>');
						//jQuery('.easyPaginateNav').html('');
						jQuery.get('katalog/pilih/'+id, function(result){
							jQuery('#peraturan_treeview').html(result);
							/*jQuery('#peraturan_treeview').easyPaginate({
								paginateElement: 'li',
								elementsPerPage: 5,
